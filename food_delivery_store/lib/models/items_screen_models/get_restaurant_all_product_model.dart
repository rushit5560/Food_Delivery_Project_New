...
String getRestaurantAllProductModelToJson(GetRestaurantAllProductModel data) => json.encode(data.toJson());

class GetRestaurantAllProductModel {
  GetRestaurantAllProductModel({
