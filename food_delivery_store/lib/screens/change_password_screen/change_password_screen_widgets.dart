...
class OldPasswordFieldModule extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Obx(
      () => TextFormField(
        controller: screenController.oldPassFieldController,
...
class NewPasswordFieldModule extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Obx(
          () => TextFormField(
        controller: screenController.newPassFieldController,
        cursorColor: AppColors.colorDarkPink,
...
class CNewPasswordFieldModule extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Obx(
          () => TextFormField(
        controller: screenController.cNewPassFieldController,
        cursorColor: AppColors.colorDarkPink,
...
InputDecoration changePassInputDecoration(
  ...
  return InputDecoration(
    ...
    suffixIcon: index == 1
        ? Obx(
            () => GestureDetector(
              onTap: () => controller.isOldPassVisible.value =
        ...
        : index == 2
            ? Obx(
                () => GestureDetector(
                  onTap: () => controller.isNewPassVisible.value =
            ...
            : Obx(
                () => GestureDetector(
                  onTap: () => controller.isCNewPassVisible.value =
