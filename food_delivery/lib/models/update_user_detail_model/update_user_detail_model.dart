...
UpdateUserDetailsModel updateUserDetailsModelFromJson(String str) => UpdateUserDetailsModel.fromJson(json.decode(str));

String updateUserDetailsModelToJson(UpdateUserDetailsModel data) => json.encode(data.toJson());
...
class UpdateUserDetailsModel {
  ...
  factory UpdateUserDetailsModel.fromJson(Map<String, dynamic> json) => UpdateUserDetailsModel(
