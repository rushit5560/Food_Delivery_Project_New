    ...
    return Container(
      child: Row(
        ...
        children: [
          Row(
            children: [
              Image.asset(Images.ic_sms, scale: 2,),

              SizedBox(width: 20,),

              Text("SMS", style: TextStyle(fontSize: 19, color: Colors.black, fontWeight: FontWeight.bold),)
            ],
          ),
    ...
    return Container(
      child: Row(
        ...
        children: [
          Row(
            children: [
              Image.asset(Images.ic_inapp, scale: 2,),

              SizedBox(width: 20,),

              Text("IN APP", style: TextStyle(fontSize: 19, color: Colors.black, fontWeight: FontWeight.bold),)
            ],
          ),
    ...
    return Container(
      child: Row(
        ...
        children: [
          Row(
            children: [
              Image.asset(Images.ic_email, scale: 2,),

              SizedBox(width: 20,),

              Text("EMAIL", style: TextStyle(fontSize: 19, color: Colors.black, fontWeight: FontWeight.bold),)
            ],
          ),
